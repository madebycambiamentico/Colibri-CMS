...
/*
* add CONTACT FORM section on the standard template Colibrì 2016.
* @see /php/Colibri-ReCaptcha/ReCaptcha
*
...
<div id="contactform">
	<h2>Contacts</h2>
	<div id="fluidform">
		<form data-action="<?php echo Links::file('contact-admin.php') ?>" action="<?php echo Links::file('contact-admin.php') ?>" method="POST">
			<ul>
				<li>
